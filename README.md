# G 框架与 Dream-RSI：公开在先谱系与结构对照

# GaoZheng G-Framework and Dream-RSI: Public-Priority Lineage and Structural Comparison

## 核心结论｜Core finding

**中文：** G 框架中文工作笔记 v5.0 已于 2026-07-17 公开收录下列四篇形式系统文稿，早于 Dream-RSI 于 2026-09-14 提交约 59 天。四篇文稿已经联合建立：PDE 低残差同伦命中、LHTS 偏微下降运动内核、TPH 外层轨迹控制、有限回放证据域、广义分形轨迹族递归扩张、正交下降界及分层证书。Dream-RSI 随后公开的“冻结执行器—外层策略—历史回放—策略选择—在线再部署”闭环，在功能拓扑上与上述体系形成连续、成组而非孤立的对应。因此，G 框架属于 Dream-RSI 无法由一般性引用替代的公开在先相关工作，其时间谱系、结构关系及贡献边界应得到正面讨论。

**English:** G-Framework Chinese Working Notes v5.0 publicly included the four formal-system manuscripts below on 17 July 2026, approximately 59 days before Dream-RSI was submitted on 14 September 2026. Together, the four manuscripts had already established PDE low-residual homotopy hitting, the LHTS partial-descent motion kernel, TPH outer trajectory control, a finite replay evidence domain, recursive expansion of generalized-fractal trajectory families, an orthogonal descent bound, and layered certificates. Dream-RSI's later public loop of “frozen executor—outer policy—historical replay—policy selection—online redeployment” forms a continuous, grouped rather than isolated functional-topological correspondence with that system. The G-Framework is therefore publicly prior related work that cannot be replaced by generic citations, and its timeline, structural relationship, and contribution boundary warrant direct discussion.
...
| Dream-RSI | [arXiv:2609.14858](https://arxiv.org/abs/2609.14858) / [public repository](https://github.com/zhengkid/Dream-RSI) | submitted 2026-09-14 | 后发公开工程体系；与四篇公开在先文稿进行结构与贡献边界对照。<br><br>Later public engineering system; compared against the four publicly prior manuscripts for structural relationship and contribution boundaries. |
...
本谱系只采用 Zenodo 外部公开记录作为版本证据：共享概念 DOI 的 v5.0、v5.1 与 v5.2 三个记录均公开收录上述四篇同名 PDF；其中 v5.0 于 2026-07-17 已完成公开存证，v5.1 与 v5.2 继续收录这些文稿。文件名中的 2026-05-13 至 2026-05-18 是文稿署期，不替代 2026-07-17 这一可核公开日期。

This lineage uses only the externally public Zenodo records as version evidence. The v5.0, v5.1, and v5.2 records under the shared concept DOI all publicly contain the four same-named PDFs; v5.0 had already deposited them publicly on 17 July 2026, and v5.1/v5.2 continued to include them. The dates 13–18 May 2026 embedded in the filenames are manuscript dates and do not replace the verifiable public date of 17 July 2026.

因此，公开时间线已经建立：四篇 G 框架文稿至迟在 Dream-RSI 提交前约 59 天公开存在，且其核心结构由 v5.0 连续继承至 v5.1/v5.2。G 框架的公开在先地位及其作为直接相关工作的资格不依赖对 Dream-RSI 主观动机的判断。

The public timeline therefore establishes that the four G-Framework manuscripts were available no later than approximately 59 days before the Dream-RSI submission and that their core structures were carried continuously from v5.0 into v5.1/v5.2. The G-Framework's public priority and status as directly relevant work do not depend on a judgment about Dream-RSI's subjective intent.
...
## G-Framework mathematical layers not reached by Dream-RSI

**中文：** 全面核对 Dream-RSI 的公开工程结构与四篇 v5.0 原典后，Dream-RSI 尚未提供以下数学层：
...
**English:** After a full comparison of Dream-RSI's public engineering structure with the four v5.0 source manuscripts, Dream-RSI does not yet provide the following mathematical layers:
...
综合时间线与结构对照，当前能够确立的是：G 框架 v5.0 是公开在先且范围更广的理论体系；Dream-RSI 复现了其中“冻结内核—外层控制—有限回放—候选选择—递归回填”的工程主链，却没有给出该主链在 G 框架中的 PDE 残差、广义分形正交覆盖、L-测度与证书数学层。因此，Dream-RSI 应在 Related Work 中正式引用并讨论 G 框架，准确限定自身工程贡献。公开材料本身尚不裁定作者的主观接触史或主观动机；这一归责边界不削弱已经成立的公开在先、直接相关性和引用义务。

Taken together, the timeline and structural comparison establish that G-Framework v5.0 is the publicly prior and broader theoretical system. Dream-RSI reproduces the engineering main chain “frozen kernel—outer control—finite replay—candidate selection—recursive feedback,” but does not supply the PDE-residual, generalized-fractal orthogonal-coverage, L-measure, and certificate mathematics already present in the G-Framework. Dream-RSI should therefore formally cite and discuss the G-Framework in Related Work and delimit its own engineering contribution accurately. The public record alone does not adjudicate the authors' subjective access history or intent; that attribution boundary does not weaken the established public priority, direct relevance, or citation obligation.

## Dream-RSI 需要回应的问题｜Questions for the Dream-RSI authors

1. Dream-RSI 的文献检索为何没有引用 2026-07-17 已公开的 G 框架 v5.0 四篇相关文稿？团队是否曾检索、阅读或讨论这些材料？
   Why did Dream-RSI's literature review omit the four relevant G-Framework v5.0 manuscripts publicly available on 17 July 2026? Were these materials searched, read, or discussed by the team?
2. 团队能否公开足以解释上述成组结构对应的概念形成、实现和文献检索时间线？
   Can the team disclose a concept-development, implementation, and literature-search timeline sufficient to explain the grouped structural correspondences above?
3. 团队是否会在 Related Work 或后续版本中正式引用 G 框架，并明确 Dream-RSI 的独立工程贡献边界？
   Will the team formally cite the G-Framework in Related Work or a future revision and clearly delimit Dream-RSI's independent engineering contribution?
...
本节欢迎基于原文、版本记录和可复验证据的具体修正。在出现能够改变时间线或结构判断的新证据前，G 框架的公开在先地位及其作为 Dream-RSI 直接相关工作的结论保持成立。

Specific corrections grounded in primary texts, version records, and reproducible evidence are welcome. Unless new evidence changes the timeline or structural findings, the G-Framework's public priority and status as directly relevant work to Dream-RSI remain established.
