...
def default_init_state() -> PRMState:
...
RULES: Dict[str, Dict[str, str]] = {
    "Identity": {},
    "Ingest": {"b": "up", "perim": "up", "f": "up"},
    "Exercise": {"b": "down", "perim": "down", "f": "up"},
    "Hormone": {},
    "Proliferation": {"n": "up", "perim": "up", "b": "up", "f": "down"},
    "Adaptation": {"b": "down", "perim": "down", "f": "up", "n": "down"},
    "Stimulus": {"b": "up", "perim": "up", "f": "down"},
}


def _instantiate(name: str, params: Dict[str, Any] | None = None) -> PRMOperator:
    mapping = {
        "Identity": Identity,
        "Ingest": Ingest,
        "Exercise": Exercise,
...
class RuleEngine:
    def __init__(self) -> None:
        ...
        self.stop_conditions: List[Callable[[PRMState], bool]] = []
        self.forbidden_pairs: List[Tuple[str, str]] = [
            ("Stimulus", "Proliferation"),
        ]
        self.require_followups: Dict[str, Tuple[int, List[str]]] = {
            "Ingest": (3, ["Exercise", "Adaptation"]),
            "Stimulus": (5, ["Adaptation", "Exercise"]),
        }

    def within_bounds(self, s: PRMState) -> bool:
