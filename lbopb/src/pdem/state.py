...
class PDEMState:
    ...
    - b: 药效负荷/效应强度 B(S)=μ(S) ≥ 0
    - n_comp: 作用位点/模块数 N_comp(S) ∈ N
    - perim: 接口/信号边界 P(S)=μ(∂S) ≥ 0
    - fidelity: 相对 Emax 百分比 F(S) ∈ [0,1]
    - meta: 元信息（上下文、标签等）
    """
    ...
    def with_meta(self, **meta: Any) -> "PDEMState":
        d = dict(self.meta or {})
        d.update(meta)
